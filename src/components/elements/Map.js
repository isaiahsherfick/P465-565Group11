...
import { setSearchData } from '../../helpers/common';
...
class Map extends Component{
    ...
    handleSubmit= event =>{
		...
		// } 
		const latData = getLatitude()
        //console.log("raass explore",latData)
        const longData = getLongitude()
        //console.log("raass explore",longData)
		axios.post('https://roadmappr.herokuapp.com/explore', { longitude: longData, latitude: latData })
		  .then(res=>{
			console.log(res);
		...
		if( this.props.center.lat !== undefined ) {
			...
			map = <div>
				...
				<AsyncMap
					...
					googleMapURL={`https://maps.googleapis.com/maps/api/js?key=${GoogleMapsAPI}&libraries=places&callback=initMap`}	
					//googleMapURL = {`https://maps.googleapis.com/maps/api/js?key=${GoogleMapsAPI}&callback=initMap`}				
					loadingElement={
