...
import { getmapCityData } from '../../helpers/common';
import { getmapstartCity } from '../../helpers/common';
...
componentDidMount() {
    ...
    const origin = JSON.parse(getmapstartCity());

    //const destination = { lat: 6.4667, lng:  3.4500};
    const destination = JSON.parse(getmapCityData());
